...
/*
    @Override
    public UserDO acceso(String user, String pass) {
        return this.userDAO.validateUserAndPass(user,pass);

    }
    */
    @Override
    public UserDO acceso(UserDO userDO) {
        return this.userDAO.validateUserAndPass(userDO.getUser(),userDO.getPass());
    }
